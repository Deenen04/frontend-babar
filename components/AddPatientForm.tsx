...
export default function AddPatientForm({ onCancel, onSubmit, patient, isEdit = false }: AddPatientFormProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const patientData = {
      ...
      insuranceProvider: formData.providerName || '-',
            ...
            <div>
              ...
              <div className="flex">
                <select
                  ...
                  className="px-3 py-2 border border-gray-300 rounded-l-md focus:outline-none focus:ring-1 focus:ring-primary focus:border-primary bg-gray-50"
                >
